          ...
          <section className="text-gray-600 body-font">
            <div className="container px-5 py-24 mx-auto">
              ...
              <motion.div
                  ...
                  className="p-4 xl:w-1/3 md:w-1/2"
                >
               <Section>  <div className="p-6 transition-transform border border-gray-200 rounded-lg shadow-md shadow-slate-700 hover:scale-105 dark:border-slate-900">
